...
if "%gpu_type%"=="AMD" (
    ...
    python -m pip install torch-directml torch==2.6.0 torchvision==0.21.0 torchaudio==2.6.0 onnx==1.17.0 onnx-simplifier==0.4.36 onnxruntime==1.21.0 onnxruntime-directml==1.20.1 numpy==2.1.1
)
